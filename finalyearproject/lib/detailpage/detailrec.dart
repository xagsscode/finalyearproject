...
class RectDetailPage extends StatefulWidget {
  final String headingName;
  final List<String>? steps;

  const RectDetailPage({
    Key? key,
  ...
  @override
  _RectDetailPageState createState() => _RectDetailPageState();
}

class _RectDetailPageState extends State<RectDetailPage> {
  int _currentStep = 0;
