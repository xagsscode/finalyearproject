...
class ReligiousDetailPage extends StatefulWidget {
  final String headingName;
  final List<String>? steps;

  const ReligiousDetailPage({
    Key? key,
  ...
  @override
  _ReligiousDetailPageState createState() => _ReligiousDetailPageState();
}

class _ReligiousDetailPageState extends State<ReligiousDetailPage> {
  int _currentStep = 0;
